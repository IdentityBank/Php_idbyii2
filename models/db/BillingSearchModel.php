 ...
 */
class BillingSearchModel extends ActiveRecord
{
    ...
    {
        return Yii::$app->get('p57b_billing_search');
    }
    ...
    {
        $this->searchPassword = BillingConfig::get()->getYii2BillingSearchPassword();
        $this->blowfishCost = BillingConfig::get()->getYii2BillingSearchBlowfishCost();
