 ...
 */
class BusinessLogModel extends IdbLogModel
{
    ...
    {
        return Yii::$app->get('p57b_business_log');
    }
    ...
    {
        $this->logPassword = BusinessConfig::get()->getYii2BusinessLogPassword();
        $this->blowfishCost = BusinessConfig::get()->getYii2BusinessLogBlowfishCost();
