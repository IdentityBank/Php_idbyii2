 ...
 */
class BusinessSearchModel extends ActiveRecord
{
    ...
    {
        return Yii::$app->get('p57b_business_search');
    }
    ...
    {
        $this->searchPassword = BusinessConfig::get()->getYii2BusinessSearchPassword();
        $this->blowfishCost = BusinessConfig::get()->getYii2BusinessSearchBlowfishCost();
