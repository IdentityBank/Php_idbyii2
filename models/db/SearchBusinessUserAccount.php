...
/**
 * Class SearchBusinessUserAccount
 *
 * @package idbyii2\models\db
 */
class SearchBusinessUserAccount extends BusinessSearchModel
{
    ...
    {
        return 'p57b_search.business_user_account';
    }
    ...
    public static function refreshAll()
    {
        ...
        $query = BussinesUserAccount::find();
