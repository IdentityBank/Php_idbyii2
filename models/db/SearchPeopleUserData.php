...
/**
 * Class SearchPeopleUserData
 *
 * @package idbyii2\models\db
 */
class SearchPeopleUserData extends PeopleSearchModel
{
    ...
    {
        return 'p57b_search.people_user_data';
    }
        ...
        if ($searchModel) {
            $model = PeopleUserData::find()
                                   ->where(
                                       [
                                           'uid' => $searchModel->uid,
                                           'key_hash' => PeopleUserData::instantiate()->getKeyHash(
                                               $searchModel->uid,
                                               $key
                                           )
                                       ]
