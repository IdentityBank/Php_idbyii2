...
<div align="center">
    ...
    <h1 align="center" style="color: black; font-size: xx-large; font-family: <?= $fontFamily ?>;">
        <b><?= Translate::_('idbyii2', 'Password Recovery Token') ?></b>
    </h1>
    <br>
    <p align="left">
    ...
    <h2 align="center" style="color: red; font-size: x-large; font-family: <?= $fontFamily ?>;">
        <b><?= Translate::_('idbyii2', 'VERY IMPORTANT') ?></b>
    </h2>
    ...
    <h1 align="center" style="color: black; font-size: large; font-family: <?= $fontFamily ?>;">
        <b><?= Translate::_('idbyii2', 'QR code') ?></b>
    </h1>
    <p align="center">
    ...
    <h1 align="center" style="color: black; font-size: large; font-family: <?= $fontFamily ?>;">
        <b><?= Translate::_('idbyii2', 'Recovery Token') ?></b>
    </h1>
    <p align="left">
        <code style="color: black; font-size: medium;"><b><?= $passwordToken->value ?></b></code>
    </p>
    <h1 align="center" style="color: black; font-size: large; font-family: <?= $fontFamily ?>;">
        <b><?= Translate::_('idbyii2', 'What to do with this information') ?></b>
    </h1>
    <p align="left" style="color: black; font-size: medium; font-family: <?= $fontFamily ?>;">
        <?= Translate::_(
            'idbyii2',
    ...
    <br>
    <h1 align="center" style="color: black; font-size: large; font-family: <?= $fontFamily ?>;">
        <b><?= Translate::_('idbyii2', 'What to do if you need to regain access to your account') ?></b>
    </h1>
    <p align="left" style="color: black; font-size: medium; font-family: <?= $fontFamily ?>;">
        <?= Translate::_(
            'idbyii2',
